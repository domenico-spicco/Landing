...
create table if not exists public.deck_links (
  ...
  processo_lungo_branch text not null default 'si' check (processo_lungo_branch in ('si','no')),
  lang_branch       text not null default 'it' check (lang_branch in ('it','en')),
